    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 z-10">
        <button
          ...
          className="flex items-center space-x-2 glass-effect px-4 py-2 rounded-xl text-white hover:bg-white/20 transition-apple"
        >
          <ArrowLeft className="h-5 w-5" />
          <span className="font-sf-pro-text">Back</span>
        </button>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8 animate-fadeInUp">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <img src={shareLahLogo} alt="ShareLah Logo" className="w-10 h-10" />
          ...
          <div className="glass-effect rounded-2xl p-8 animate-fadeInUp delay-300">
            ...
            <div className="flex bg-white/10 rounded-xl p-1 mb-8">
              <button
                ...
                className={`flex-1 py-3 px-4 rounded-lg transition-apple font-medium font-sf-pro-text ${
                  isLogin
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  ...
                  disabled={isLoading}
                  className="flex justify-center items-center px-4 py-3 bg-white/10 border border-white/20 rounded-xl hover:bg-white/20 transition-apple text-white font-sf-pro-text disabled:opacity-50 disabled:cursor-not-allowed"
                >
